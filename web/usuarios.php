  ...
  <div class="modal-container">
    <div class="modal">
      <form action="cadastrausuario.php" method="post">
        ...
        <input id="m-senha" name="userPassword" type="password" required>

        <label for="m-email">Email:</label>
        <input id="m-email" name="userEmail" type="email" required>

        <label for="m-tipo">Tipo de Conta:</label>
        <select id="m-tipo" name="userType" required>
